...
import { simpleGetTutorials, simpleCompleteTutorial } from "@/services/simpleAuth";
...
const SimpleTutorials = () => {
  ...
  useEffect(() => {
    console.log("=== SIMPLE TUTORIALS PAGE AUTH CHECK ===");
  ...
  const handleCompleteTutorial = async (tutorial: Tutorial) => {
    console.log("=== SIMPLE HANDLE COMPLETE TUTORIAL ===");
    ...
    try {
      const response = await simpleCompleteTutorial(tutorial._id);
...
export default SimpleTutorials;
